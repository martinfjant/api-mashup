...
function () {
  ...
  _createClass(Search, [{
    key: "fetchFlickr",
    value: function fetchFlickr(query) {
      var fetchNew = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      ...
      var flickrQueryParams = urlEncodeData(params);
      var queryUrl = "".concat(flickrUrl).concat(flickrQueryParams);
    ...
    value: function _do() {
      ...
      var promises = [this.fetchFlickr(query), this.fetchword(query)];
